...
type Numbers<'a> = HashMap<Cow<'a, str>, usize>;
...
fn render_event<'a>(event: Event<'a>, numbers: &mut Numbers<'a>, w: &mut Write) -> fmt::Result {
  match event {
...
fn render_start_tag<'a>(tag: Tag<'a>, numbers: &mut Numbers<'a>, mut w: &mut Write) -> fmt::Result {
  match tag {
...
fn render_footnote_definition_start_tag<'a>(name: Cow<'a, str>, numbers: &mut Numbers<'a>, mut w: &mut Write) -> fmt::Result {
...
fn render_footnote_reference<'a>(name: Cow<'a, str>, numbers: &mut Numbers<'a>, mut w: &mut Write) -> fmt::Result {
